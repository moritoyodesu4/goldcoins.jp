...
$require = array('ご用件', '氏名', '電話番号', 'Email', 'お問い合わせ内容');
if ($_POST['ご用件'] === '出張買取') {
	$require = array('ご用件', '氏名', '電話番号', 'Email', '郵便番号', '住所', '出張希望日時', '買取内容の情報', 'お問い合わせ内容');
} else if ($_POST['ご用件'] === '宅配買取') {
	$require = array('ご用件', '氏名', '電話番号', 'Email', '郵便番号', '住所', '買取内容の情報', 'お問い合わせ内容');
}
...
$re_subject = "【まねきや】お問い合わせいただきありがとうございます。";
...
株式会社 水野(まねきや運営会社)
【東京本社】
〒160-0023　東京都新宿区西新宿 7-1-2 川安ビル2階
TEL: 03-6908-5688
【大阪本社】
〒530-0027　大阪府大阪市北区堂山町1-5 三共梅田ビル３階
TEL: 06-6232-8066
URL:
【株式会社水野HP】
https://miduno.jp
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-194781214-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-194781214-3');
</script>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
		<meta name="format-detection" content="telephone=no">
		<title>確認画面 | お問い合わせフォーム</title>
		<link href="./lp_contact.css" rel="stylesheet" type="text/css" media="all">
	</head>
...
})(window,document,'script','dataLayer','GTM-W5DVJTT');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W5DVJTT"
